...
import com.internation.info.model.ArticleExample.Criterion;
...
public class ArticleSqlProvider {
    ...
    public String insertSelective(Article record) {
        ...
        if (record.getOriginal() != null) {
            sql.VALUES("original", "#{original,jdbcType=INTEGER}");
        }
        ...
        if (record.getBlog_type() != null) {
            sql.VALUES("blog_type", "#{blog_type,jdbcType=VARCHAR}");
        }
        
        if (record.getIspublish() != null) {
            sql.VALUES("ispublish", "#{ispublish,jdbcType=INTEGER}");
        }
        
        if (record.getIsprivate() != null) {
            sql.VALUES("isprivate", "#{isprivate,jdbcType=INTEGER}");
        }
        ...
        if (record.getIdentifyingCode() != null) {
            sql.VALUES("identifyingCode", "#{identifyingCode,jdbcType=VARCHAR}");
        }
    ...
    public String selectByExample(ArticleExample example) {
        ...
        sql.SELECT("content");
        sql.SELECT("uid");
        sql.SELECT("blog_type");
        sql.SELECT("ispublish");
        sql.SELECT("isprivate");
        sql.SELECT("createTime");
        sql.SELECT("seecount");
        sql.SELECT("identifyingCode");
        sql.FROM("article");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getOriginal() != null) {
            sql.SET("original = #{record.original,jdbcType=INTEGER}");
        }
        ...
        if (record.getBlog_type() != null) {
            sql.SET("blog_type = #{record.blog_type,jdbcType=VARCHAR}");
        }
        
        if (record.getIspublish() != null) {
            sql.SET("ispublish = #{record.ispublish,jdbcType=INTEGER}");
        }
        
        if (record.getIsprivate() != null) {
            sql.SET("isprivate = #{record.isprivate,jdbcType=INTEGER}");
        }
        ...
        if (record.getIdentifyingCode() != null) {
            sql.SET("identifyingCode = #{record.identifyingCode,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Article record) {
        ...
        if (record.getOriginal() != null) {
            sql.SET("original = #{original,jdbcType=INTEGER}");
        }
        ...
        if (record.getBlog_type() != null) {
            sql.SET("blog_type = #{blog_type,jdbcType=VARCHAR}");
        }
        
        if (record.getIspublish() != null) {
            sql.SET("ispublish = #{ispublish,jdbcType=INTEGER}");
        }
        
        if (record.getIsprivate() != null) {
            sql.SET("isprivate = #{isprivate,jdbcType=INTEGER}");
        }
        ...
        if (record.getIdentifyingCode() != null) {
            sql.SET("identifyingCode = #{identifyingCode,jdbcType=VARCHAR}");
        }
