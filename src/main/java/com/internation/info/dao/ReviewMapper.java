...
public interface ReviewMapper {
    ...
    @Insert({
        ...
        "article_id, message, ",
        "createTime, floor_number, ",
        "like_number, unlike_number, ",
        "seecount, isRevert, ",
        "revertfloor, revert, ",
        "revertUid, revertCreateTime)",
        ...
        "#{createTime,jdbcType=TIMESTAMP}, #{floor_number,jdbcType=INTEGER}, ",
        "#{like_number,jdbcType=INTEGER}, #{unlike_number,jdbcType=INTEGER}, ",
        "#{seecount,jdbcType=INTEGER}, #{isRevert,jdbcType=INTEGER}, ",
        "#{revertfloor,jdbcType=INTEGER}, #{revert,jdbcType=VARCHAR}, ",
        "#{revertUid,jdbcType=INTEGER}, #{revertCreateTime,jdbcType=TIMESTAMP})"
    })
    ...
    @Results({
        ...
        @Result(column="revertUid", property="revertUid", jdbcType=JdbcType.INTEGER),
    ...
    @Select({
        "select",
        "id, article_title, authorId, observer_id, article_id, message, createTime, floor_number, ",
        "like_number, unlike_number, seecount, isRevert, revertfloor, revert, revertUid, ",
        "revertCreateTime",
        "from review",
        "where id = #{id,jdbcType=INTEGER}"
    })
    ...
    @Update({
        ...
        "set article_title = #{article_title,jdbcType=VARCHAR},",
          ...
          "isRevert = #{isRevert,jdbcType=INTEGER},",
          "revertfloor = #{revertfloor,jdbcType=INTEGER},",
          "revert = #{revert,jdbcType=VARCHAR},",
          "revertUid = #{revertUid,jdbcType=INTEGER},",
